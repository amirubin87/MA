...
def AverageF1(Comms1Path,GroundTruthPath, outputPath):    
    ...
    output.close()
'''
OmegaIndex('./communityAsListOfNodes.dat','./output-1.01.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.02.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.03.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.04.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.05.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.06.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.07.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.08.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.09.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.1.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.2.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.3.dat', './Omega.sum')
OmegaIndex('./communityAsListOfNodes.dat','./output-1.4.dat', './Omega.sum')
